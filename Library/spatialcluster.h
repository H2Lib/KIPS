 ...
 * 
 *  Releases the storage corresponding to the spatialcluster object.
 *  If the cluster has sons, their storage is released too.
 * 
 *  @param s The @ref spatialcluster object to be deleted.*/
HEADER_PREFIX void
 ...
 *  spatialcluster object once the index sets of the leaf clusters have been set.
 ...
 *  @returns Euclidean norm of the diameter of @p s.*/
HEADER_PREFIX real
 ...
 *  @returns Distance of @p s and @p t.*/
HEADER_PREFIX real
 ...
 *  spatialcluster objects. This unit cell and the clusters therein are replicated 
 ...
 *
 *  @returns Distance of @p s and @p t in consideration of periodic copies. */
HEADER_PREFIX real
 ...
 * 
 *  The periodic grid is determined by the bounding box which contains all original 
 *  spatialcluster objects. This unit cell and the clusters therein are replicated in 
 *  every spatial direction. The point is required to be inside the original bounding box.
 * 
 *  @param x Given point.
 *  @param t Given @ref spatialcluster object.
 *  @param a Minimal coordinates of the unit cell.
 *  @param b Maximal coordinates of the unit cell.
 *
 *  @returns Distance of @p x and @p t in consideration of periodic copies. */
HEADER_PREFIX real
