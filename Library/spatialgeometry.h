 ...
 * 
 *  @param sg The @ref spatialgeometry object to be deleted.*/
HEADER_PREFIX void
 ...
 * 
 *  Builds an adaptive spatialcluster tree from the bounding box
 *  given in a @ref spatialgeometry object. Bisects every spatialcluster
 ...
 *  spatialcluster objects on one level have congruent bounding boxes.
 *  Information about the bisection steps and the pointers to the 
 *  spatialcluster objects are stored in the respective spatialgeometry object.
 * 
 ...
 * 
 *  Finds the respective spatialcluster object with bounding box containing 
 *  the given point in three-dimensional space on a given level of a 
 *  spatialcluster tree administrated by a spatialgeometry object.
 * 
 ...
 * 
 *  Allocates storage for the index sets of all leaf spatialcluster objects 
 *  in the given @ref spatialgeometry and initializes them with the indices 
 *  of those points that are contained in the respective spatialcluster.
 * 
 *  @param nidx Number of vectors to be distributed.
 *  @param x Vector array to be distributed.
 *  @param sg The @ref spatialgeometry object to distribute into. */
HEADER_PREFIX void
